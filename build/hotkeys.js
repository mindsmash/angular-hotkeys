...
(function(window, document, undefined) {
    ...
    function Mousetrap(targetElement) {
        ...
        self._handleKey = function(character, modifiers, e) {
            ...
            var ignoreThisKeypress = type == 'keypress' && _ignoreNextKeypress;
            if (type == _nextExpectedAction && !_isModifier(character) && !ignoreThisKeypress) {
                _resetSequences(doNotReset);
            }

            _ignoreNextKeypress = processedSequenceCallback && type == 'keydown';
        };
        ...
        function _handleKeyEvent(e) {
            ...
            // need to use === for the character check because the character can be 0
            if ((!!e && !!e.type ? e.type : '') == 'keyup' && _ignoreNextKeyup === character) {
                _ignoreNextKeyup = false;
                return;
            }
